...
set_property IOSTANDARD LVCMOS33 [get_ports enable_decryption]
set_property IOSTANDARD LVCMOS33 [get_ports enable_encryption]
set_property IOSTANDARD LVCMOS33 [get_ports start_gen]
set_property PACKAGE_PIN P15 [get_ports enable_encryption]
set_property PACKAGE_PIN W13 [get_ports enable_decryption]
set_property PACKAGE_PIN P16 [get_ports start_gen]
