...
#
# Generated by Vivado on Sun Dec 05 16:11:10 -0500 2021
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L xlconstant_v1_1_5 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot HDMI_bd xil_defaultlib.HDMI_bd xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim HDMI_bd -key {Behavioral:sim_1:Functional:HDMI_bd} -tclbatch cmd.tcl -protoinst "protoinst_files/HDMI_bd.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb HDMI_bd.wdb xsim.dir)
