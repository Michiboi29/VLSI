...
set_property PACKAGE_PIN W13 [get_ports {CTRL[2]}]
set_property PACKAGE_PIN P15 [get_ports {CTRL[1]}]
set_property PACKAGE_PIN G15 [get_ports {CTRL[0]}]
...
set_property PACKAGE_PIN Y17 [get_ports {LEDs[6]}]
set_property PACKAGE_PIN T17 [get_ports {LEDs[5]}]
set_property PACKAGE_PIN U17 [get_ports {LEDs[4]}]
set_property PACKAGE_PIN V13 [get_ports {LEDs[3]}]
set_property PACKAGE_PIN H15 [get_ports {LEDs[2]}]
set_property PACKAGE_PIN J15 [get_ports {LEDs[1]}]
set_property PACKAGE_PIN W16 [get_ports {LEDs[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports Ready_out]
set_property IOSTANDARD LVCMOS33 [get_ports Start_gen]
set_property PACKAGE_PIN V12 [get_ports Ready_out]
set_property PACKAGE_PIN K18 [get_ports Start_gen]
