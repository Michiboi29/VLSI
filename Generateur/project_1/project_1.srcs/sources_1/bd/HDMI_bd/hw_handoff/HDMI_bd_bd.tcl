...
proc create_root_design { parentCell } {
  ...
  set CTRL [ create_bd_port -dir I -from 2 -to 0 CTRL ]
  ...
  # Create instance: mux30_7_0, and set properties
  set block_name mux30_7
  set block_cell_name mux30_7_0
  if { [catch {set mux30_7_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $mux30_7_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
  ...
  connect_bd_net -net CTRL_1 [get_bd_ports CTRL] [get_bd_pins mux30_7_0/CTRL]
  connect_bd_net -net Generator_0_KeyReady [get_bd_ports Ready_out] [get_bd_pins Generator_0/KeyReady]
  connect_bd_net -net Generator_0_Key_out [get_bd_pins Generator_0/Key_out] [get_bd_pins mux30_7_0/Data_in]
  ...
  connect_bd_net -net dvi2rgb_0_PixelClk [get_bd_pins Generator_0/PixelClk] [get_bd_pins dvi2rgb_0/PixelClk] [get_bd_pins rgb2dvi_0/PixelClk]
  connect_bd_net -net dvi2rgb_0_vid_pData [get_bd_pins Generator_0/RGB_in] [get_bd_pins dvi2rgb_0/vid_pData] [get_bd_pins rgb2dvi_0/vid_pData]
  ...
  connect_bd_net -net mux30_7_0_Data_out [get_bd_ports LEDs] [get_bd_pins mux30_7_0/Data_out]
  connect_bd_net -net reset_1 [get_bd_ports reset] [get_bd_pins Generator_0/Reset] [get_bd_pins clk_wiz_0/reset] [get_bd_pins dvi2rgb_0/aRst] [get_bd_pins dvi2rgb_0/pRst] [get_bd_pins rgb2dvi_0/aRst]
