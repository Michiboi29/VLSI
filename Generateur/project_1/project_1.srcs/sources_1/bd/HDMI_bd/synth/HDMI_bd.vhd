...
architecture STRUCTURE of HDMI_bd is
  ...
  component HDMI_bd_mux30_7_0_0 is
  port (
    CTRL : in STD_LOGIC_VECTOR ( 2 downto 0 );
    Data_in : in STD_LOGIC_VECTOR ( 30 downto 0 );
    Data_out : out STD_LOGIC_VECTOR ( 6 downto 0 )
  );
  end component HDMI_bd_mux30_7_0_0;
  ...
  signal CTRL_1 : STD_LOGIC_VECTOR ( 2 downto 0 );
  ...
  signal mux30_7_0_Data_out : STD_LOGIC_VECTOR ( 6 downto 0 );
...
begin
  CLK_1 <= CLK;
  CTRL_1(2 downto 0) <= CTRL(2 downto 0);
  LEDs(6 downto 0) <= mux30_7_0_Data_out(6 downto 0);
  Ready_out <= Generator_0_KeyReady;
...
mux30_7_0: component HDMI_bd_mux30_7_0_0
     port map (
      CTRL(2 downto 0) => CTRL_1(2 downto 0),
      Data_in(30 downto 0) => Generator_0_Key_out(30 downto 0),
      Data_out(6 downto 0) => mux30_7_0_Data_out(6 downto 0)
    );
