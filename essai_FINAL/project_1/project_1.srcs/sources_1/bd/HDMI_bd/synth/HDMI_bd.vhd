...
architecture STRUCTURE of HDMI_bd is
  ...
  component HDMI_bd_mux_decrypt_0_0 is
  port (
    SEL : in STD_LOGIC;
    PixelClk : in STD_LOGIC;
  ...
  end component HDMI_bd_mux_decrypt_0_0;
  ...
  signal Generator_0_Key_out : STD_LOGIC_VECTOR ( 199 downto 0 );
  ...
  signal mux_decrypt_0_Data_out : STD_LOGIC_VECTOR ( 23 downto 0 );
  signal mux_decrypt_0_Hsync_out : STD_LOGIC;
  signal mux_decrypt_0_VDE_out : STD_LOGIC;
  signal mux_decrypt_0_Vsync_out : STD_LOGIC;
...
Decryption_0: component HDMI_bd_Decryption_0_0
     port map (
      ...
      key(199 downto 0) => Generator_0_Key_out(199 downto 0),
...
Generator_0: component HDMI_bd_Generator_0_0
     port map (
      ...
      Key_out(199 downto 0) => Generator_0_Key_out(199 downto 0),
      PixelClk => dvi2rgb_0_PixelClk,
...
mux_decrypt_0: component HDMI_bd_mux_decrypt_0_0
     port map (
      Data_decr(23 downto 0) => Decryption_0_data_out(23 downto 0),
      Data_encr(23 downto 0) => Encryption_0_data_out(23 downto 0),
      Data_out(23 downto 0) => mux_decrypt_0_Data_out(23 downto 0),
      Hsync_decr => Decryption_0_HSync_out,
      Hsync_encr => Encryption_0_HSync_out,
      Hsync_out => mux_decrypt_0_Hsync_out,
      PixelClk => dvi2rgb_0_PixelClk,
      SEL => Enable_decryption_1,
      VDE_decr => Decryption_0_VDE_out,
      VDE_encr => Encryption_0_VDE_out,
      VDE_out => mux_decrypt_0_VDE_out,
      Vsync_decr => Decryption_0_VSync_out,
      Vsync_encr => Encryption_0_VSync_out,
      Vsync_out => mux_decrypt_0_Vsync_out
    );
rgb2dvi_0: component HDMI_bd_rgb2dvi_0_0
     port map (
      ...
      aRst => reset_1,
      vid_pData(23 downto 0) => mux_decrypt_0_Data_out(23 downto 0),
      vid_pHSync => mux_decrypt_0_Hsync_out,
      vid_pVDE => mux_decrypt_0_VDE_out,
      vid_pVSync => mux_decrypt_0_Vsync_out
    );
