...
HD_PWD='U:/VLSI/LABO3/numero8/project_1.runs/HDMI_bd_xlconstant_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log HDMI_bd_xlconstant_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source HDMI_bd_xlconstant_0_0.tcl
