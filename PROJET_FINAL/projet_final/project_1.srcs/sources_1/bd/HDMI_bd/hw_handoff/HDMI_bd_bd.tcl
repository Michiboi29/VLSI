...
proc create_root_design { parentCell } {
  ...
  # Create instance: RTL_0, and set properties
  set block_name RTL
  set block_cell_name RTL_0
  if { [catch {set RTL_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
  ...
  connect_bd_net -net RTL_0_LED0 [get_bd_ports LED0] [get_bd_pins RTL_0/LED0]
  connect_bd_net -net RTL_0_LED1 [get_bd_ports LED1] [get_bd_pins RTL_0/LED1]
  connect_bd_net -net RTL_0_LED2 [get_bd_ports LED2] [get_bd_pins RTL_0/LED2]
  ...
  connect_bd_net -net dvi2rgb_0_vid_pData [get_bd_pins RTL_0/data_in] [get_bd_pins dvi2rgb_0/vid_pData] [get_bd_pins rgb2dvi_0/vid_pData]
