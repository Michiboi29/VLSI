...
-- Date        : Sun Oct 31 22:36:47 2021
-- Host        : pcetu-126 running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               U:/VLSI/LABO3/numero8/project_1.srcs/sources_1/bd/HDMI_bd/ip/HDMI_bd_rgb2dvi_0_0/HDMI_bd_rgb2dvi_0_0_sim_netlist.vhdl
...
entity HDMI_bd_rgb2dvi_0_0_OutputSERDES is
  port (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity HDMI_bd_rgb2dvi_0_0_OutputSERDES_0 is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of HDMI_bd_rgb2dvi_0_0_OutputSERDES_0 : entity is "OutputSERDES";
end HDMI_bd_rgb2dvi_0_0_OutputSERDES_0;

architecture STRUCTURE of HDMI_bd_rgb2dvi_0_0_OutputSERDES_0 is
  signal I : STD_LOGIC;
  signal SHIFTIN1 : STD_LOGIC;
  signal SHIFTIN2 : STD_LOGIC;
  signal NLW_SerializerMaster_OFB_UNCONNECTED : STD_LOGIC;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity HDMI_bd_rgb2dvi_0_0_OutputSERDES_2 is
  port (
    TMDS_Data_p : out STD_LOGIC_VECTOR ( 0 to 0 );
    TMDS_Data_n : out STD_LOGIC_VECTOR ( 0 to 0 );
    SerialClk : in STD_LOGIC;
    pLockGained_reg : in STD_LOGIC;
    pDataOut : in STD_LOGIC_VECTOR ( 9 downto 0 );
    \out\ : in STD_LOGIC_VECTOR ( 0 to 0 )
  );
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of HDMI_bd_rgb2dvi_0_0_OutputSERDES_2 : entity is "OutputSERDES";
end HDMI_bd_rgb2dvi_0_0_OutputSERDES_2;

architecture STRUCTURE of HDMI_bd_rgb2dvi_0_0_OutputSERDES_2 is
  signal I : STD_LOGIC;
  signal SHIFTIN1 : STD_LOGIC;
  signal SHIFTIN2 : STD_LOGIC;
  signal NLW_SerializerMaster_OFB_UNCONNECTED : STD_LOGIC;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity HDMI_bd_rgb2dvi_0_0_OutputSERDES_4 is
  port (
    TMDS_Data_p : out STD_LOGIC_VECTOR ( 0 to 0 );
    TMDS_Data_n : out STD_LOGIC_VECTOR ( 0 to 0 );
    SerialClk : in STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of HDMI_bd_rgb2dvi_0_0_OutputSERDES_4 : entity is "OutputSERDES";
end HDMI_bd_rgb2dvi_0_0_OutputSERDES_4;

architecture STRUCTURE of HDMI_bd_rgb2dvi_0_0_OutputSERDES_4 is
  signal I : STD_LOGIC;
  signal SHIFTIN1 : STD_LOGIC;
  signal SHIFTIN2 : STD_LOGIC;
  signal NLW_SerializerMaster_OFB_UNCONNECTED : STD_LOGIC;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity HDMI_bd_rgb2dvi_0_0_SyncAsync is
  port (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity HDMI_bd_rgb2dvi_0_0_SyncAsync_6 is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of HDMI_bd_rgb2dvi_0_0_SyncAsync_6 : entity is "SyncAsync";
end HDMI_bd_rgb2dvi_0_0_SyncAsync_6;

architecture STRUCTURE of HDMI_bd_rgb2dvi_0_0_SyncAsync_6 is
  signal oSyncStages : STD_LOGIC_VECTOR ( 1 downto 0 );
  attribute async_reg : string;
  attribute async_reg of oSyncStages : signal is "true";
  attribute ASYNC_REG_boolean : boolean;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity \HDMI_bd_rgb2dvi_0_0_SyncAsync__parameterized1\ is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of \HDMI_bd_rgb2dvi_0_0_SyncAsync__parameterized1\ : entity is "SyncAsync";
end \HDMI_bd_rgb2dvi_0_0_SyncAsync__parameterized1\;

architecture STRUCTURE of \HDMI_bd_rgb2dvi_0_0_SyncAsync__parameterized1\ is
  signal oSyncStages : STD_LOGIC_VECTOR ( 1 downto 0 );
  attribute async_reg : string;
  attribute async_reg of oSyncStages : signal is "true";
  attribute ASYNC_REG_boolean : boolean;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity HDMI_bd_rgb2dvi_0_0_TMDS_Encoder is
  port (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity HDMI_bd_rgb2dvi_0_0_TMDS_Encoder_1 is
  port (
    Q : out STD_LOGIC_VECTOR ( 9 downto 0 );
    PixelClk : in STD_LOGIC;
    vid_pData : in STD_LOGIC_VECTOR ( 7 downto 0 );
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of HDMI_bd_rgb2dvi_0_0_TMDS_Encoder_1 : entity is "TMDS_Encoder";
end HDMI_bd_rgb2dvi_0_0_TMDS_Encoder_1;

architecture STRUCTURE of HDMI_bd_rgb2dvi_0_0_TMDS_Encoder_1 is
  signal cnt_t_2 : STD_LOGIC_VECTOR ( 4 downto 1 );
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity HDMI_bd_rgb2dvi_0_0_TMDS_Encoder_3 is
  port (
    Q : out STD_LOGIC_VECTOR ( 9 downto 0 );
    PixelClk : in STD_LOGIC;
    vid_pData : in STD_LOGIC_VECTOR ( 7 downto 0 );
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of HDMI_bd_rgb2dvi_0_0_TMDS_Encoder_3 : entity is "TMDS_Encoder";
end HDMI_bd_rgb2dvi_0_0_TMDS_Encoder_3;

architecture STRUCTURE of HDMI_bd_rgb2dvi_0_0_TMDS_Encoder_3 is
  signal cnt_t_2 : STD_LOGIC_VECTOR ( 4 downto 1 );
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity HDMI_bd_rgb2dvi_0_0_ResetBridge is
  port (
    \out\ : out STD_LOGIC_VECTOR ( 0 to 0 );
    in0 : in STD_LOGIC;
    PixelClk : in STD_LOGIC
...
begin
  aRst_int <= in0;
SyncAsyncx: entity work.HDMI_bd_rgb2dvi_0_0_SyncAsync
     port map (
      AS(0) => aRst_int,
      PixelClk => PixelClk,
      \out\(0) => \out\(0)
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity HDMI_bd_rgb2dvi_0_0_ResetBridge_5 is
  port (
    AR : out STD_LOGIC_VECTOR ( 0 to 0 );
    aRst : in STD_LOGIC;
    PixelClk : in STD_LOGIC
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of HDMI_bd_rgb2dvi_0_0_ResetBridge_5 : entity is "ResetBridge";
end HDMI_bd_rgb2dvi_0_0_ResetBridge_5;

architecture STRUCTURE of HDMI_bd_rgb2dvi_0_0_ResetBridge_5 is
  signal aRst_int : STD_LOGIC;
  attribute RTL_KEEP : string;
  attribute RTL_KEEP of aRst_int : signal is "true";
begin
  aRst_int <= aRst;
SyncAsyncx: entity work.HDMI_bd_rgb2dvi_0_0_SyncAsync_6
     port map (
      AR(0) => AR(0),
      AS(0) => aRst_int,
      PixelClk => PixelClk
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity HDMI_bd_rgb2dvi_0_0_ClockGen is
  port (
...
LockLostReset: entity work.HDMI_bd_rgb2dvi_0_0_ResetBridge_5
     port map (
      AR(0) => pRst,
      PixelClk => PixelClk,
      aRst => aRst
    );
PLL_LockSyncAsync: entity work.\HDMI_bd_rgb2dvi_0_0_SyncAsync__parameterized1\
     port map (
      D(0) => oOut,
      PixelClk => PixelClk,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity HDMI_bd_rgb2dvi_0_0_rgb2dvi is
  port (
    TMDS_Clk_p : out STD_LOGIC;
    TMDS_Clk_n : out STD_LOGIC;
  ...
  attribute kClkRange of HDMI_bd_rgb2dvi_0_0_rgb2dvi : entity is 3;
  attribute kClkSwap : string;
  attribute kClkSwap of HDMI_bd_rgb2dvi_0_0_rgb2dvi : entity is "FALSE";
  attribute kD0Swap : string;
  attribute kD0Swap of HDMI_bd_rgb2dvi_0_0_rgb2dvi : entity is "FALSE";
  attribute kD1Swap : string;
  attribute kD1Swap of HDMI_bd_rgb2dvi_0_0_rgb2dvi : entity is "FALSE";
  attribute kD2Swap : string;
  attribute kD2Swap of HDMI_bd_rgb2dvi_0_0_rgb2dvi : entity is "FALSE";
  attribute kGenerateSerialClk : string;
  attribute kGenerateSerialClk of HDMI_bd_rgb2dvi_0_0_rgb2dvi : entity is "TRUE";
  attribute kRstActiveHigh : string;
  attribute kRstActiveHigh of HDMI_bd_rgb2dvi_0_0_rgb2dvi : entity is "TRUE";
end HDMI_bd_rgb2dvi_0_0_rgb2dvi;

architecture STRUCTURE of HDMI_bd_rgb2dvi_0_0_rgb2dvi is
...
begin
\ClockGenInternal.ClockGenX\: entity work.HDMI_bd_rgb2dvi_0_0_ClockGen
     port map (
      PixelClk => PixelClk,
      SerialClk => SerialClkIO,
      TMDS_Clk_n => PixelClkIO,
      aRst => aRst,
      in0 => aRstLck
    );
ClockSerializer: entity work.HDMI_bd_rgb2dvi_0_0_OutputSERDES
     port map (
      PixelClk => PixelClkIO,
      SerialClk => SerialClkIO,
...
\DataEncoders[0].DataEncoder\: entity work.HDMI_bd_rgb2dvi_0_0_TMDS_Encoder
     port map (
      PixelClk => PixelClk,
...
\DataEncoders[0].DataSerializer\: entity work.HDMI_bd_rgb2dvi_0_0_OutputSERDES_0
     port map (
      PixelClk => PixelClkIO,
      SerialClk => SerialClkIO,
...
\DataEncoders[1].DataEncoder\: entity work.HDMI_bd_rgb2dvi_0_0_TMDS_Encoder_1
     port map (
      PixelClk => PixelClk,
...
\DataEncoders[1].DataSerializer\: entity work.HDMI_bd_rgb2dvi_0_0_OutputSERDES_2
     port map (
      SerialClk => SerialClkIO,
      ...
      pLockGained_reg => PixelClkIO
    );
\DataEncoders[2].DataEncoder\: entity work.HDMI_bd_rgb2dvi_0_0_TMDS_Encoder_3
     port map (
      PixelClk => PixelClk,
...
\DataEncoders[2].DataSerializer\: entity work.HDMI_bd_rgb2dvi_0_0_OutputSERDES_4
     port map (
      SerialClk => SerialClkIO,
...
LockLostReset: entity work.HDMI_bd_rgb2dvi_0_0_ResetBridge
     port map (
      PixelClk => PixelClk,
      in0 => aRstLck,
      \out\(0) => pRstLck
...
entity HDMI_bd_rgb2dvi_0_0 is
  ...
  attribute NotValidForBitStream of HDMI_bd_rgb2dvi_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of HDMI_bd_rgb2dvi_0_0 : entity is "HDMI_bd_rgb2dvi_0_0,rgb2dvi,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of HDMI_bd_rgb2dvi_0_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of HDMI_bd_rgb2dvi_0_0 : entity is "rgb2dvi,Vivado 2018.2";
end HDMI_bd_rgb2dvi_0_0;

architecture STRUCTURE of HDMI_bd_rgb2dvi_0_0 is
  attribute kClkPrimitive : string;
...
begin
U0: entity work.HDMI_bd_rgb2dvi_0_0_rgb2dvi
     port map (
      PixelClk => PixelClk,
      SerialClk => '0',
      TMDS_Clk_n => TMDS_Clk_n,
