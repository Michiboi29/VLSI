...
#
# Generated by Vivado on Mon Nov 29 14:14:21 -0500 2021
...
# Design libraries
design_libs=(xil_defaultlib xpm xlconstant_v1_1_5)

# Simulation root library directory
sim_lib_dir="vcs_lib"

# Script info
echo -e "HDMI_bd.sh - Script generated by export_simulation (Vivado v2018.3 (64-bit)-id)\n"
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../project_1.srcs/sources_1/bd/HDMI_bd/ipshared/85a3" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../../project_1.srcs/sources_1/bd/HDMI_bd/ipshared/85a3" \
  ...
  vlogan -work xlconstant_v1_1_5 $vlogan_opts +v2k +incdir+"$ref_dir/../../../../project_1.srcs/sources_1/bd/HDMI_bd/ipshared/85a3" \
    "$ref_dir/../../../../project_1.srcs/sources_1/bd/HDMI_bd/ipshared/4649/hdl/xlconstant_v1_1_vl_rfs.v" \
  2>&1 | tee -a vlogan.log
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    ...
    "$ref_dir/../../../bd/HDMI_bd/ip/HDMI_bd_RTL_0_0/sim/HDMI_bd_RTL_0_0.vhd" \
  2>&1 | tee -a vhdlan.log
